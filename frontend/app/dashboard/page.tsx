            ...
            <div className="flex flex-col sm:flex-row w-full max-w-6xl gap-4 sm:gap-8 row-start-2">
                ...
                <aside className="flex sm:flex-col bg-white rounded shadow p-2 sm:p-6 mb-4 sm:mb-0 min-w-0 sm:min-w-[180px] max-w-full sm:max-w-[220px] w-full sm:w-auto h-auto sm:h-full gap-1 sm:gap-4 overflow-x-auto">
                    <nav className="flex flex-row sm:flex-col gap-1 sm:gap-2 w-full">
                        <a href="#" className="flex-1 text-gray-700 py-2 px-2 sm:px-3 rounded hover:bg-blue-50 transition text-xs sm:text-base text-center sm:text-left">Bookings</a>
                        <a href="#" className="flex-1 text-gray-700 py-2 px-2 sm:px-3 rounded hover:bg-blue-50 transition text-xs sm:text-base text-center sm:text-left">Clients</a>
                        <a href="#" className="flex-1 text-gray-700 py-2 px-2 sm:px-3 rounded hover:bg-blue-50 transition text-xs sm:text-base text-center sm:text-left">Marketing</a>
                        <a href="#" className="flex-1 text-gray-700 py-2 px-2 sm:px-3 rounded hover:bg-blue-50 transition text-xs sm:text-base text-center sm:text-left">Calendar</a>
                        <a href="#" className="flex-1 text-gray-700 py-2 px-2 sm:px-3 rounded hover:bg-blue-50 transition text-xs sm:text-base text-center sm:text-left">Inventory</a>
                        <a href="#" className="flex-1 text-gray-700 py-2 px-2 sm:px-3 rounded hover:bg-blue-50 transition text-xs sm:text-base text-center sm:text-left">Staff</a>
                        <a href="#" className="flex-1 text-gray-700 py-2 px-2 sm:px-3 rounded hover:bg-blue-50 transition text-xs sm:text-base text-center sm:text-left">Settings</a>
                    </nav>
                </aside>
                {/* Main Content */}
